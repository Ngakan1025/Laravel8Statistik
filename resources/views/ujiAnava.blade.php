...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="d-flex justify-content-end">
            ...
            <!-- Modal -->
            <div class="modal fade" id="ujitberkolerasi" tabindex="-1" role="dialog" aria-labelledby="ujitberkolerasi"
                aria-hidden="true">
            ...
            <div class="card-body">
                <form method="post" action="/ujiAnava" id="forminput">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control mb-2" placeholder="Masukkan Nilai X1" name="x1"
                            value="{{ old('x1') }}">
                        <label for="input2">Input X2</label>
                        <input required type="text" class="form-control mb-2" placeholder="Masukkan Nilai X2" name="x2"
                            value="{{ old('x2') }}">
                        <label for="input3">Input X3</label>
                        <input required type="text" class="form-control mb-2" placeholder="Masukkan Nilai X3" name="x3"
                            value="{{ old('x3') }}">
                        <label for="input4">Input X4</label>
                        <input required type="text" class="form-control mb-2" placeholder="Masukkan Nilai X4" name="x4"
                            value="{{ old('x4') }}">
                    ...
                    <tbody class="">
                        @for ($i = 0; $i < $jumlahData; $i++) <tr>
                            <tr>
                                ...
                                <td>
                                    <form name="delete" action="/hapusAnava/{{ $ujiAnava[$i]->id }}" method="POST">
